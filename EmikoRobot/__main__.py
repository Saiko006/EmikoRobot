...
PM_START_TEXT = """
*Hello {} !*
◉ ɴᴀᴍᴀᴋᴜ ᴀᴅᴀʟᴀʜ ɴᴇ̷ᴏɴ ʀᴏʙᴏᴛ [✨](https://telegra.ph/file/727bd3ccec9422ed0c884.jpg)
◉ ꜱᴀʏᴀ ᴀᴅᴀʟᴀʜ ʙᴏᴛ ᴍᴀɴᴀᴊᴇᴍᴇɴ ᴅᴀɴ ᴍᴜꜱɪᴄ
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
◉ ᴅɪ ᴋᴇʟᴏʟᴀ ᴏʟᴇʜ☕ [夢 | ꜱᴀɪᴋᴏ](https://t.me/teleudahhina).
"""

buttons = [
    [
        InlineKeyboardButton(text=f"ᴀʙᴏᴜᴛ {dispatcher.bot.first_name}", callback_data="emiko_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="🤖 ᴀᴅᴅ ɴᴇᴏɴ ᴛᴏ ɢʀᴜʙ 🤖", url=f"t.me/{bu}?startgroup=new"),
    ],
]
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            f"👋 Hi frend, i'm alive {dispatcher.bot.first_name}. Nice to meet You.",
